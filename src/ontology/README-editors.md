These notes are for the EDITORS of aibgt
...
Make sure you have an ID range in the [idranges file](aibgt-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [aibgt-edit.owl](aibgt-edit.owl)

** DO NOT EDIT aibgt.obo OR aibgt.owl in the top level directory **

[../../aibgt.owl](../../aibgt.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/patrick-lloyd-ray/aibgt) for details.
 ...
 * [aibgt-idranges.owl](aibgt-idranges.owl)
...
This generates derived files such as aibgt.owl and aibgt.obo and places
 ...
 * https://github.com/patrick-lloyd-ray/aibgt/releases
 * https://github.com/patrick-lloyd-ray/aibgt/releases/new
...
what is in the `owl:versionIRI` of the derived aibgt.owl (`data-version` in
aibgt.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/aibgt.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/aibgt/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/patrick-lloyd-ray/aibgt.svg?branch=master)](https://travis-ci.org/patrick-lloyd-ray/aibgt)
...
Note: if you have only just created this project you will need to authorize travis for this repo.
 ...
 3. Click the tick symbol next to aibgt
